      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-3xl font-bold text-white mb-1">$46,030.50</div>
          ...
          <div className="text-right">
            <div className="text-gray-400 text-sm mb-2">Across 4 wallets</div>
            <div className="text-cyan-400 font-semibold">Secure & Encrypted</div>
          </div>
        </div>
      </motion.div>
            ...
            <div className="relative bg-gray-900/80 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 hover:border-gray-600 transition-all duration-300">
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm capitalize">{wallet.type} • {wallet.network}</p>
                  </div>
                </div>
                <div className="flex items-center gap-1">
                  {wallet.encrypted && <Shield className="w-4 h-4 text-green-400" />}
              ...
              {showPrivateKeys && (
                <div className="mb-4">
                  ...
                  <div className="flex items-center justify-between bg-gray-800/50 rounded-lg p-3">
                    ...
                    <button
                      onClick={() => copyToClipboard('private_key_here')}
                      className="p-1 text-white/80 hover:text-cyan-300 transition-colors"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/20">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="p-2 text-white/80 hover:text-blue-300 transition-colors">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-yellow-300 text-sm">
              Your wallet private keys are encrypted and stored securely. Never share your private keys with anyone. 
